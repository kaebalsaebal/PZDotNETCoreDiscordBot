...
namespace DotNETCoreDiscordBot
{
    ...
    public class ServerScheduleSettings
    {
        ...
        public uint WorkshopUpdateSchedule = Convert.ToUInt32(TimeSpan.FromMinutes(15).TotalMilliseconds);
        public uint BotUpdateSchedule = Convert.ToUInt32(TimeSpan.FromMinutes(30).TotalMilliseconds);
